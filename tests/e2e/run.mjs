...
async function main() {
  ...
  let code = 1;
  try {
    for (const suite of ['smoke.mjs', 'difficulty-demo.mjs', 'endless-demo.mjs', 'map-demo.mjs', 'maps-all-demo.mjs', 'randgen-demo.mjs', 'migration-demo.mjs', 'conquest-maps-demo.mjs', 'thumbs-demo.mjs', 'mobile.mjs']) {
